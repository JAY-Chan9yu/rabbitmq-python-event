...
class RabbitMQConnection:
    ...
    async def _reconnect(self):
        ...
        print(f"RabbitMQ Disconnected. Reconnecting in %d seconds. {connection_delay}")
...
class RabbitMQ:
    ...
    def __init__(
        ...
        connection_string = f"amqp://{rabbit_username}:{rabbit_password}@{rabbit_host}:{rabbit_port}/default"
    ...
    def consume_keywords(self, callback):
        kwargs = dict(queue=self._queue, on_message_callback=callback, auto_ack=True)
    ...
    def publish_keywords(self, keywords, routing_key: str):
